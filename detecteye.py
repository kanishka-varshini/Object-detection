...
while True: 
    ...
    eye = eye_cascade.detectMultiScale(gray, 1.2, 2) #detects eyes of different sizes in the input image
    #here, 1.2 is the scale factor, the image will be resized to 120% of its original size in each iteration
    #2 is the minNeighbors value
    #for a window to be classified as containing an eye, at least two Haar features within the window must be positively classified by the cascade classifier stages
